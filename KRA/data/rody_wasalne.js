const rodyWasalneDb = [
  ...
  // 2. RÓD PRZYSIĘGŁY: HRABIA ŚWIDNICKI (Wasal Wielkiego Rodu Świnków)
  {
    ...
    n14_ranga: "Hrabia",
    n15_publicEstate: "Brak",
    n16_businessEstate: "Nieruchomość ziemska o wielkości 30 ha, położona w gminie Świdnik wraz z folwarkiem rolnym",
    n17_publicLegalBasis: "Nie dotyczy",
  ...
  // 3. RÓD ZIEMSKI: BARON POGRANICZA SOWIEGO (Wasal Wielkiego Rodu Strigallorów)
  {
    ...
    // 1. INFORMACJE O TYTULE
    n11_title: "Baron Pogranicza Sowiego",
    n12_creationOrder: "Postanowienie Krula Multikont nr 9/T/2026 z dnia 25.02.2026 r.",
    classes: {
      publicFunction: false,
      landAndBusiness: true,
      honorary: false
    ...
    n14_ranga: "Baron",
    n15_publicEstate: "Brak",
    n16_businessEstate: "Winnica i strażnica graniczna Pogranicza Sowiego",
    n17_publicLegalBasis: "Nie dotyczy",
    n18_ringDesc: "Srebrny sygnet z topazem",
    n19_dates: "25.02.2026 r./nie dotyczy",
